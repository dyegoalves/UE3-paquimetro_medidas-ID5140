gdjs.Est1Code = {};
gdjs.Est1Code.GDbtAvancarGObjects1= [];
gdjs.Est1Code.GDbtAvancarGObjects2= [];
gdjs.Est1Code.GDbtAvancarGObjects3= [];
gdjs.Est1Code.GDbtVoltarGObjects1= [];
gdjs.Est1Code.GDbtVoltarGObjects2= [];
gdjs.Est1Code.GDbtVoltarGObjects3= [];
...
{for(var i = 0, len = gdjs.Est1Code.GDPaquimetroObjects1.length ;i < len;++i) {
    ...
    gdjs.Est1Code.GDbtAvancarGObjects1[i].hide();
}
}}
...
gdjs.Est1Code.condition0IsTrue_0.val = false;
{
gdjs.Est1Code.condition0IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.Est1Code.mapOfGDgdjs_46Est1Code_46GDbtAvancarGObjects1Objects, runtimeScene, true, false);
...
gdjs.Est1Code.condition0IsTrue_0.val = false;
{
for(var i = 0, k = 0, l = gdjs.Est1Code.GDs1Objects1.length;i<l;++i) {
    if ( gdjs.Est1Code.GDs1Objects1[i].hasAnimationEnded() ) {
        gdjs.Est1Code.condition0IsTrue_0.val = true;
        gdjs.Est1Code.GDs1Objects1[k] = gdjs.Est1Code.GDs1Objects1[i];
        ++k;
    }
}
...
};gdjs.Est1Code.mapOfGDgdjs_46Est1Code_46GDbtAvancarGObjects1Objects = Hashtable.newFrom({"btAvancarG": gdjs.Est1Code.GDbtAvancarGObjects1});gdjs.Est1Code.eventsList4 = function(runtimeScene) {
...
/* Reuse gdjs.Est1Code.GDbtAvancarGObjects1 */
{for(var i = 0, len = gdjs.Est1Code.GDbtAvancarGObjects1.length ;i < len;++i) {
    gdjs.Est1Code.GDbtAvancarGObjects1[i].setAnimationFrame(2);
}
}}
...
};gdjs.Est1Code.eventsList5 = function(runtimeScene) {
...
gdjs.Est1Code.GDbtAvancarGObjects1.length = 0;
gdjs.Est1Code.GDbtAvancarGObjects2.length = 0;
gdjs.Est1Code.GDbtAvancarGObjects3.length = 0;
gdjs.Est1Code.GDbtVoltarGObjects1.length = 0;
gdjs.Est1Code.GDbtVoltarGObjects2.length = 0;
gdjs.Est1Code.GDbtVoltarGObjects3.length = 0;
...
gdjs.Est1Code.eventsList5(runtimeScene);
return;
